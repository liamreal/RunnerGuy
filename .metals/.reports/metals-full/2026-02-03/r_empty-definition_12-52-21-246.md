error id: file:///C:/College/Stage_4_Term_2/COMP30540_Game_Development/RunnerGuy/src/objects/PlayerObject.java:objects/PlayerObject#textureLocation#
file:///C:/College/Stage_4_Term_2/COMP30540_Game_Development/RunnerGuy/src/objects/PlayerObject.java
empty definition using pc, found symbol in pc: objects/PlayerObject#textureLocation#
...
public class PlayerObject extends GameObject {
    ...
    public PlayerObject(int width,int height,Point3f centre) { 
        ...
        super(this.textureLocatio@@n, width, height, centre);
	}
