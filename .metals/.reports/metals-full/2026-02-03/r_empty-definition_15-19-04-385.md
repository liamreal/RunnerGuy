error id: file:///C:/College/Stage_4_Term_2/COMP30540_Game_Development/RunnerGuy/src/objects/PlayerObject.java:_empty_/GameObject#
...
public class PlayerObject extends G@@ameObject {
    ...
    // auto-build texture based on file path (the way i will use for custom games)
